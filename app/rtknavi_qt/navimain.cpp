...
int buflen;
    ...
    buflen = sizeof(homedir);
    buflen += sizeof(program_invocation_short_name);
    buflen += 12;

    char TmpIniFile[buflen];
    snprintf(TmpIniFile, sizeof TmpIniFile, "%s%s%s%s", homedir,"/.",
        program_invocation_short_name, ".conf");
    IniFile = QString::fromUtf8(TmpIniFile);
#else
